...
export default function ChainOverview({ heartbeats }: Props) {
            ...
            <div className="overflow-x-auto max-h-80 overflow-y-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-800/20">
                  {selectedChain.guardianDetails.map((g) => {
                    const behind = selectedChain.maxHeight - g.height;
                    ...
                    return (
                      <tr key={g.name} className={`hover:bg-gray-800/20 transition-colors ${isDown ? 'opacity-50' : ''}`}>
